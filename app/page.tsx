...
export default function HomePage() {
  return (
    <div className="space-y-24 ">
      ...
      {/* HERO SECTION */}
      <section className="text-center py-20 bg-gradient-to-b from-grey to-gray-200 text-white rounded-lg">
      ...
      {/* TRABAJOS REALIZADOS */}
<section id="trabajos" className="text-center px-4 text-center py-20 bg-gradient-to-b from-grey to-gray-200 text-white rounded-lg">
  ...
  <Carousel />
      ...
      {/* UBICACIÓN */}
      <section id="ubicacion" className="text-center space-y-4 text-center py-20 bg-gradient-to-b from-grey to-gray-200 text-white rounded-lg">
